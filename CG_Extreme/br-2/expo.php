...
<?php include('include/menu.php'); ?>
	...
	<div id="ContentPavilhao">
		...
		<div id="ColunaFixaPavailhao">
			...
			<div id="ContatoPavilhao">
				<div id="TextoContantoPavilhao" class="TextoPadraoPavilhao">
					<p>Gina Bruto</p>
					<p>Recrutamento Global e Gerente de Vendas da Educação</p>
					<p>P: 415.947.6241</p>
					<p>F: 415.947.6747</p>
					<p>gina.gross@ubm.com</p>
		...
		<div id="ContentExpo">
			<span class="titulo_home">Exposição</span>
			<div class="ImgTopoPavilhao"><img src="img/pavilhao/banner-expo-talentos.jpg" alt="" /></div><!-- close ImgTopoPavilhao -->
