...
$(document)
    ...
    var checkName = function() {
        if ($('.userInput_name')
            ...
            return false;
        } else if (RegExp_UserName.test($('.userInput_name')
            .val())) {
            $('.userInput_name')
                .removeClass("failVerif");
            $('.userInput_name')
                .addClass("passVerif");
    ...
    var checkEmail = function() {
        if ($('.userInput_email')
            ...
            return false;
        } else if (RegExp_UserEmail.test($('.userInput_email')
            .val())) {
            $('.userInput_email')
                .removeClass("failVerif");
            $('.userInput_email')
    ...
    var checkSubject = function() {
        if ($('.userInput_subject')
            .val() === "Assunto" || $('.userInput_subject')
            .val() === "") {
            $('.userInput_subject')
                .addClass("failVerif");
            ...
            return false;
        } else if (RegExp_UserName.test($('.userInput_subject')
            .val())) {
            $('.userInput_subject')
                .removeClass("failVerif");
            $('.userInput_subject')
    ...
    var checkMessage = function() {
        if ($('.userInput_comment')
            .val() === "Menssagem" || $('.userInput_comment')
            .val() === "") {
            $('.userInput_comment')
                .addClass("failVerif");
            ...
            return false;
        } else if (RegExp_UserComment.test($('.userInput_comment')
            .val())) {
            $('.userInput_comment')
                .removeClass("failVerif");
            $('.userInput_comment')
