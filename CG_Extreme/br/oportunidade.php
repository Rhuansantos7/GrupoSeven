...
<?php include('include/menu.php'); ?>
	...
	<div id="ContentPavilhao">
		...
		<div id="ConteudoOportunidades">
			<span class="titulo_home">Oportunidade</span>
...
<p>Se você está em busca da primeira oportunidade de trabalho ou deseja aprender os atalhos para abrir seu próprio negócio, você está no lugar certo.  O Pavilhão é composto por empresas focadas em oferecer aos estudantes as ferramentas certas para desenvolver suas habilidades em empreendedorismo e também por empresas focadas em recrutamento.</p> 
<br>
<p>Acompanhe abaixo algumas oportunidades que serão oferecidas para os estudantes no Pavlhão de Carreiras do CG Extreme:</p>
<br>
<p>. Consultoria para abrir sua empresa própria;</p>
<p>. Network com outros profissionais da área;</p>
<p>. Reuniões agendadas entre pessoas que desejam abrir negócios;</p>
<p>. Dicas e informações dadas pela ABRAGAMES sobre a indústria nacional;</p>
<p>. Acesso a novas tecnologias, como a impressora 3D;</p>
<p>. Processos seletivos;</p>
<p>. Exposição de portifólio dos melhores alunos do Grupo Seven;</p>
<p>. Exposição de seu portifólio em mídia nacional e internacional;</p>
<br>
				<h2 class="TituloVideoPavilhao">Campeonato da We do logos</h2><br>
				<iframe width="560" height="315" src="http://www.youtube.com/embed/XoqRiTGAaWg" frameborder="0" allowfullscreen></iframe>
				<br>
				<a class="" rel="" href="img/pavilhao/wedologos.jpg" target="_blank" style="position:absolute; margin:-360px 0px 0px -220px; left:50%;"><img src="img/pavilhao/botao-saiba-mais.png" alt=""/></a>
			...
			<div id="ContentFixPavilhao">
					<div id="MenuPavilhao">
						<ul class="TextoPadraoPavilhao">
							...
							<li class="AtivoMenuPavilhao" ><a href="oportunidade.php">Oportunidades para os alunos</a></li>
