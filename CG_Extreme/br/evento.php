...
<div class="content">
	...
	<div id="content_evento">
		<div id="content_evento_esquerdo">
		...
		<div id="content_txt_evento">
			...
			<span class="txt_evento">
				...
				Computação Gráfica no cinema, na música <br>e nos games, responsáveis por trabalhos
		...
		</div><!--close content txt evento-->	
		<br>
		<br>
		<div id="video_evento">
			<iframe width="680" height="480" src="http://www.youtube.com/embed/cUxXd86ERS4" frameborder="0" allowfullscreen></iframe>
		...
		<div id="textos">
			<div id="evento_right">
				<p class="center_img"><a href="http://www.sevencg.com.br" target="new"><img src="img/evento/grupo_seven.png"></a></p><br><br>
			...
			<div id="evento_left">
				<p class="center_img"><a href="http://www.fullsail.edu/" target="new"><img src="img/evento/fullsail.png"></a></p><br><br>
		...
		</div><!--close content esquerdo-->
		
		<div id="content_evento_direito">
			<span class="evento_cronograma">CRONOGRAMA DO EVENTO</span> <br><br>
			
			<div class="marcador">
				<span>Dia 27 (Sábado)</span>
